...
function $ViewScrollProvider() {
   ...
   *
   * @description
   * Reverts back to using the controllers [`$anchorScroll`](http://docs.angularjs.org/api/ng.$anchorScroll) service for
 ...
 * `routeProvider` from the controllers. This is done to provide compatibility between
 * the UI Router and the controllers router.
 *
...
function $RouteProvider(  $stateProvider,    $urlRouterProvider) {
   ...
   * object has the same interface the angular controllers route definition object has.
   * 
   * @example
   * <pre>
   ...
   * control over all the stuff you would actually get from angular's controllers `$route`
   * service.
   */
  this.$get = $get;
